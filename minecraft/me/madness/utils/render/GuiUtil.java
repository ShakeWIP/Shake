package me.madness.utils.render;
...
public class GuiUtil {
    ...
    // Cambia i colori delle righe intorno ai disegni.
    float f = (float)(col1 >> 24 & 0x65) / 255F; // 0xFF
    float f1 = (float)(col1 >> 16 & 0x65) / 255F;// 0xFF
    float f2 = (float)(col1 >> 8 & 0x65) / 255F;// 0xFF
    float f3 = (float)(col1 & 0x65) / 255F;// 0xFF
