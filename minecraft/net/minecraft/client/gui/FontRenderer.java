...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    protected static final String __OBFID = "CL_00000660";
     ...
     */
    protected float renderCharAtPos(int par1, char par2, boolean par3)
    {
    ...
    protected ResourceLocation getUnicodePageLocation(int par1)
    {
     ...
     */
    protected void loadGlyphTexture(int par1)
    {
    ...
    protected String func_147647_b(String p_147647_1_)
    {
        try
        {
     ...
     */
    protected int renderString(String par1Str, int par2, int par3, int par4, boolean par5)
    {
        if (par1Str == null)
        {
            return 0;
     ...
     */
    protected String trimStringNewline(String par1Str)
    {
     ...
     * set
     */
    protected void renderSplitString(String par1Str, int par2, int par3, int par4, boolean par5)
    {
     ...
     */
    protected static String getFormatFromString(String par0Str)
    {
        String var1 = "";
        int var2 = -1;
